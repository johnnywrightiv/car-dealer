...
import { setInputValue, setSliderValue, setToggleValue } from "@/store/search-form-slice"
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      <div className="space-y-4">
        <div>
          ...
          />
          {errors.inputA && <p className="text-sm text-red-500 mt-1">{errors.inputA.message}</p>}
        </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <Controller
                name="sliderLower"
                control={control}
                render={({ field: { value: lowerValue, onChange: onLowerChange } }) => (
                  <Controller
                    name="sliderUpper"
                    control={control}
                    render={({ field: { value: upperValue, onChange: onUpperChange } }) => (
                      <Slider
                        min={0}
                        max={100}
                        step={1}
        ...
        <div className="flex items-center space-x-2">
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <Switch id="toggleValue" checked={field.value} onCheckedChange={field.onChange} />
            )}
          />
          ...
          <DialogContent>
            ...
            <div className="py-4">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Input id="inputB" {...field} placeholder="Type something..." />
                )}
              />
              {errors.inputB && <p className="text-sm text-red-500 mt-1">{errors.inputB.message}</p>}
            </div>
            <DialogFooter>
          ...
          <DialogContent>
            ...
            <div className="py-4">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Input id="inputC" {...field} placeholder="Type something..." />
                )}
              />
              {errors.inputC && <p className="text-sm text-red-500 mt-1">{errors.inputC.message}</p>}
            </div>
            <DialogFooter>
