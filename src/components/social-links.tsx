...
import { FaFacebookF, FaTwitter, FaInstagram, FaGoogle, FaStar } from 'react-icons/fa'; // Import the relevant icons
...
export function SocialLinks({ className = '', showHeading = true }: SocialLinksProps) {
  const socialLinks = [
  ...
  return (
    <div className={`flex items-center justify-between gap-4 ${className}`}>
      {showHeading && (
        <h2 className="text-2xl font-bold whitespace-nowrap">Connect with us.</h2>
      )}
